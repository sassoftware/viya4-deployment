...
| V4_CFG_CADENCE_VERSION | Cadence version | string | "2020.1" | true | This value must be quoted to accommodate the updated SAS Cadence Version format. If the value is not quoted the deployment will fail. | viya |
