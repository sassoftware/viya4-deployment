...
| Name | Description | Type | Default | Required | Notes | Actions |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| V4M_VERSION | Branch or tag of [viya4-monitoring-kubernetes](https://github.com/sassoftware/viya4-monitoring-kubernetes) | string | master | false | | cluster-logging, cluster-monitoring, viya-monitoring |
...
| V4M_NODE_PLACEMENT_ENABLE | Enable workload node placement for monitor components | bool | false | false | | cluster-logging, cluster-monitoring, viya-monitoring |
